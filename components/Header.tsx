...
function Header() {
  ...
  return (
    <header className="bg-gray-800 text-white shadow-md">
        ...
        <nav className="hidden md:block">
          <ul className="flex space-x-6">
            <li>
              <Link href="/">
                <a
                  className={`nav-link transition ${currentRoute === "/" ? "active" : ""}`}
                >
                  Home
                </a>
              </Link>
            ...
            <li>
              <Link href="/projects">
                <a
                  className={`nav-link transition ${currentRoute === "/projects" ? "active" : ""}`}
                >
                  Projects
                </a>
              </Link>
            ...
            <li>
              <Link href="/about">
                <a
                  className={`nav-link transition ${currentRoute === "/about" ? "active" : ""}`}
                >
                  About
                </a>
              </Link>
            ...
            <li>
              <Link href="/contact">
                <a
                  className={`nav-link transition ${currentRoute === "/contact" ? "active" : ""}`}
                >
                  Contact
                </a>
              </Link>
      ...
      <div
        className={`md:hidden bg-gray-800 border-t border-gray-700 transition-all duration-300 ${isMenuOpen ? "max-h-64 opacity-100" : "max-h-0 opacity-0 overflow-hidden"}`}
      >
